...
fp.gpx1 <- '/Users/blrice/Library/CloudStorage/Dropbox/R DROPBOX/2025_CHAMELEONS/data/gps/20260105_GPX_FILES/GPS_FILES_CHAMS/Waypoints_2025-12-24.gpx'
# fp.gpx1 <- '/Users/blrice/Library/CloudStorage/Dropbox/R DROPBOX/2025_CHAMELEONS/data/gps/20260117_GPX_FILES/GPS_FILES_FROGS/Waypoints_2026-01-16.gpx'
  ...
  for(i in 1:length(v.gpx.file_paths)){
    ...
    sf.i <- sf.i %>%
      ...
      mutate(site_code = case_when(
        ...
        date >= ymd("2026-01-12") & date <= ymd("2026-01-23") ~ "AJJ",
        date >= ymd("2026-01-25") & date <= ymd("2026-02-04") ~ "AKF",
      ))
...
gpx.file_paths.CHAM.i <- c(list.files('/Users/blrice/Library/CloudStorage/Dropbox/R DROPBOX/2025_CHAMELEONS/data/gps/20260204_GPX_FILES/GPS_FILES_CHAMS', 
                                    full.names = TRUE, include.dirs = FALSE, recursive = TRUE))
#Filtering for waypoints
gpx.file_paths.CHAM <- str_subset(gpx.file_paths.CHAM.i, "/Waypoints")

#FROGS as of 20260105
gpx.file_paths.FROG.i <- c(list.files('/Users/blrice/Library/CloudStorage/Dropbox/R DROPBOX/2025_CHAMELEONS/data/gps/20260204_GPX_FILES/GPS_FILES_FROGS', 
                                    full.names = TRUE, include.dirs = FALSE, recursive = TRUE))
#Filtering for waypoints
gpx.file_paths.FROG <- str_subset(gpx.file_paths.FROG.i, "/Waypoints")
...
#Exporting as a csv
 ...
 write_csv(sf1 %>% st_drop_geometry(), '/Users/blrice/Library/CloudStorage/Dropbox/R DROPBOX/2025_CHAMELEONS/data/gps/processed_gpx_files_20260117.CSV')
